...
def main(argv = None):
    ...
    parser.add_option("--mva", default="TOP", help="MVA name [default: %default]")
    parser.add_option("--nmax", default=100000, help="max number of events [default: %default]")
    parser.add_option("--chan", default="elec", help="channel [default: %default]")
    parser.add_option("--year", default="2016", help="year of data taking [default: %default]")
    parser.add_option("--definition", default="cuts200_depth4_trees1000_shrinkage0p1", help="hyperparameters [default: %default]")
